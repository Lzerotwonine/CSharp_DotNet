...
CREATE TABLE QuanLyKho (
    ...
    MaBang NVARCHAR(50) NOT NULL,
    LoaiGiaoDich NVARCHAR(50) NOT NULL, -- 'Nhập' hoặc 'Xuất'
    SoLuong INT NOT NULL,
...
INSERT INTO QuanLyKho (MaKho, MaBang, LoaiGiaoDich, SoLuong, NgayGiaoDich, NhaCungCapId, GhiChu) VALUES 
    ('KHO001', 'BD001', N'Nhập', 30, '2023-09-20', 'NCC001', N'Nhập hàng từ NCC001'),
    ('KHO002', 'BD002', N'Nhập', 20, '2023-09-25', 'NCC002', N'Nhập hàng từ NCC002'),
    ('KHO003', 'BD003', N'Xuất', 10, '2023-10-05', 'NCC003', N'Xuất hàng cho khách'),
    ('KHO004', 'BD004', N'Nhập', 15, '2023-10-10', 'NCC004', N'Nhập hàng từ NCC004'),
    ('KHO005', 'BD005', N'Xuất', 5, '2023-10-15', 'NCC005', N'Xuất hàng cho khách');
