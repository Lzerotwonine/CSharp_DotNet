...
{
    public partial class BangForm : Form, IView
    {
        private BangController bangController = new BangController();
        private BangModel currentBang;
        ...
        {
            dataGridViewBang.AutoGenerateColumns = false;
            ...
            dataGridViewBang.Columns.Add(maBangColumn);
            ...
            dataGridViewBang.Columns.Add(tenBangColumn);
            ...
            dataGridViewBang.Columns.Add(soLuongColumn);
            ...
            dataGridViewBang.Columns.Add(donGiaColumn);
            ...
            dataGridViewBang.Columns.Add(theLoaiColumn);
            ...
            dataGridViewBang.Columns.Add(tacGiaColumn);
        }
        ...
        {
            bangController.Load();
            var bangs = bangController.Items.Cast<BangModel>().ToList();
            dataGridViewBang.DataSource = bangs;
        }

        // Lấy dữ liệu từ form
        public void GetDataFromText()
        {
            if (currentBang == null) currentBang = new BangModel();
        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewBang.DataSource = result;
        }
        ...
        private void dataGridViewBang_SelectionChanged(object sender, EventArgs e)
        {
            var selectedRow = dataGridViewBang.SelectedRows.Cast<DataGridViewRow>().FirstOrDefault();
            if (selectedRow != null)
            {
                var bang = (BangModel)selectedRow.DataBoundItem;
                SetDataToText(bang);
            }
        }
