...
namespace CD_Management.Controller
{
    ...
    {
        private readonly string connectionString = "Data Source=DESKTOP-08N8TNO\\SQLEXPRESS;Initial Catalog=CD_Management;Integrated Security=True;TrustServerCertificate=True";
