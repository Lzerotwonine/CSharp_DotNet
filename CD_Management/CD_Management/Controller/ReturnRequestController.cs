...
namespace CD_Management.Controller
{
    ...
    {
        private string connectionString = "Data Source=DESKTOP-08N8TNO\\SQLEXPRESS;Initial Catalog=CD_Management;Integrated Security=True"; // Cập nhật kết nối cơ sở dữ liệu
