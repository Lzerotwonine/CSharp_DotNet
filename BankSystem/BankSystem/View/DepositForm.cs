...
namespace BankSystem.View
{
    public partial class DepositForm : Form, IView
    {
        ...
        public DepositForm()
        {
            ...
            int? latestTransactionId = transactionController.GetLatestTransactionId(TransactionController.TransactionType.Deposit);
        ...
        public void GetDataFromText()
        {
            try
            {
                ...
                if (transactionController.ProcessTransaction(accountId, depositAmount, "Deposit", employeeId, branchId, description, pin))
                {
