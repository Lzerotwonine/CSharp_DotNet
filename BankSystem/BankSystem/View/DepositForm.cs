...
namespace BankSystem.View
{
    public partial class DepositForm : Form, IView
    {
        ...
        public DepositForm()
        {
            ...
            int? latestTransactionId = transactionController.GetLatestDepositTransactionId();
        ...
        public void GetDataFromText()
        {
            try
            {
                ...
                if (success)
                {
                    ...
                    // Lấy ID giao dịch mới nhất và hiển thị lên textBoxTransactionId
                    int? latestTransactionId = transactionController.GetLatestDepositTransactionId();
                    textBoxTransactionId.Text = latestTransactionId.HasValue ? latestTransactionId.Value.ToString() : "Không tìm thấy giao dịch";
                }
                else
                {
